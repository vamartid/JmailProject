...
//    private Socket SOCK;
    ...
    private void initComponents() {
        ...
        start.setToolTipText("Εκκινηση JavaMail Client");
        ...
        ipL.setColumns(1);
        ipL.setFont(new java.awt.Font("Calibri Light", 0, 26)); // NOI18N
        ipL.setForeground(new java.awt.Color(255, 255, 255));
        ipL.setText("127.0.0.1");
        ipL.setToolTipText("Εισήγαγε το IP στο οποίο θες να τρέχει ο Client.");
        ipL.setBorder(null);
        ipL.setName(""); // NOI18N
        ipL.setOpaque(false);
        ...
        ipL.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                ipLKeyTyped(evt);
            }
        });
        getContentPane().add(ipL, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 240, 30));

        portL.setColumns(1);
        portL.setFont(new java.awt.Font("Calibri Light", 0, 26)); // NOI18N
        portL.setForeground(new java.awt.Color(255, 255, 255));
        portL.setText("6666");
        portL.setToolTipText("Εισήγαγε το PORT στο οποίο θες να τρέχει ο Client.");
        ...
        getContentPane().add(portL, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 240, 30));
        ...
        backround.setIcon(new javax.swing.ImageIcon(getClass().getResource("/vamartid/test1/images/client.png"))); // NOI18N
    ...
    private void startActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startActionPerformed
        ...
        try {
            ...
            new Z_menu(SOCK).setVisible(true);
        } catch (IOException ex) {
            System.err.println("Something went wrong with the Socket Creation");
        }
...
//System.out.println(x+" "+y);
    ...
    private void ipLKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ipLKeyTyped
        char c = evt.getKeyChar();
        if ( c!=46 && !(c>=48&&c<=57) ) {
            evt.consume();  // ignore event
        }
    }//GEN-LAST:event_ipLKeyTyped
